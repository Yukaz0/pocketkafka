...
// EncodeCreateTopicsRequest serializes the request body.
...
// DecodeCreateTopicsResponse parses the response body.
...
// EncodeDeleteTopicsRequest serializes the request body.
...
// DecodeDeleteTopicsResponse parses the response body.
